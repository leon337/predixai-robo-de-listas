...
CURRENT_PHASE=CONFLICTS_AND_SUPERSESSIONS
CURRENT_GATE=G5_CONFLICTS_AND_SUPERSESSIONS_RESOLVED
...
```text
NEXT_ACTION=BUILD_CONFLICT_SUPERSESSION_PRECEDENCE_REGISTER_IN_PR_40
```
