...
`V27-SAF-001` é o único requisito diferido canônico para `ADR-CAND-017`. `V27-SAF-008` foi removido deste ADR e reconciliado no ADR-0016, seu controlador temporal correto.

```text
PRIMARY_DOMAINS=DOM-09|DOM-11|DOM-12
SECONDARY_DOMAINS=DOM-06|DOM-08|DOM-15|DOM-16
HANDOFFS=H-05|H-06|H-07|H-08|H-12
DEFERRED_REQUIREMENTS_FROM_P0_APPENDIX=V27-SAF-001
DEFERRED_REQUIREMENT_COUNT=1
COMPLEMENTARY_REQUIREMENTS=PTM-V26-005..006|PTM-V26-009..022|V26-VAL-003..006|V26-ANA-001..011|V26-STR-001..004|V26-SIG-001..008|V27-QA-001..007
...
V27_SAF_008_REMOVED=PASS_BUILDER_REMEDIATED
...
Status `ACCEPTED`. A decisão foi aprovada pela revisão crítica independente `LEA-31` no Reteste 02 e publicada com confirmação final da LEA-30. A aceitação não transforma thresholds provisórios em autoridade de GO e não autoriza runtime.