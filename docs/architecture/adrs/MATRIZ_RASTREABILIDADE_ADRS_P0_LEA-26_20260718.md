...
```text
DOCUMENT_STATUS=CONTENT_VALIDATED_OPERATIONAL_RETEST_03_PENDING
MISSION=LEA-26
REVIEW_ISSUE=LEA-27
...
Executar `LEA-27 — Reteste 03` sobre o novo HEAD vivo do PR #46. O `PASS_RETEST_02` não autoriza merge após as correções exigidas pela verificação pré-merge.