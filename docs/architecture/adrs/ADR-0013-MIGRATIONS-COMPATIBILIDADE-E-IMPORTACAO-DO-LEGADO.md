...
O apêndice canônico P0 não marcou requisitos como diferidos para `ADR-CAND-003`; os contratos de persistência e legado já estavam decididos principalmente pelo ADR-0002. Este ADR acrescenta governança complementar necessária antes da implementação, sem reclassificar ou substituir os requisitos P0.

```text
PRIMARY_DOMAINS=DOM-03
SECONDARY_DOMAINS=DOM-01|DOM-16
HANDOFFS=H-11
DEFERRED_REQUIREMENTS_FROM_P0_APPENDIX=NONE
COMPLEMENTARY_REQUIREMENTS=PTM-V25-001..006|PTM-V25-014A..014E|PTM-V25-016|V25-DB-001..005|V25-LEG-001..006|PTM-V26-023|PTM-V26-027|PTM-V27-029
...
INDIVIDUAL_TRACEABILITY_CLASSIFICATION=PASS_BUILDER_REMEDIATED
SQL_CREATED=NO
...
Status `ACCEPTED`. A decisão foi aprovada pela revisão crítica independente `LEA-31` no Reteste 02 e publicada com confirmação final da LEA-30. A aceitação não cria SQL, migrations ou autorização de execução.