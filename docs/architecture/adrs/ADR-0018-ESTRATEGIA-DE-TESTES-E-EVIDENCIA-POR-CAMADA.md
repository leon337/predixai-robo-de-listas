...
`V25-QA-002` é o requisito diferido canônico de `ADR-CAND-018`. Os demais vínculos abaixo são complementares e permanecem associados às decisões P0 que já os governam.

```text
PRIMARY_DOMAINS=DOM-16
SECONDARY_DOMAINS=DOM-03|DOM-04|DOM-08|DOM-09|DOM-11|DOM-13|DOM-14|DOM-15
HANDOFFS=H-04|H-05|H-07|H-09|H-10|H-11|H-12
DEFERRED_REQUIREMENTS_FROM_P0_APPENDIX=V25-QA-002
DEFERRED_REQUIREMENT_COUNT=1
COMPLEMENTARY_REQUIREMENTS=V25-QA-001|V25-SEC-001|PTM-V26-024..028|V26-RPL-001..003|V26-API-001..002|V26-SEC-001..003|PTM-V27-010..019|PTM-V27-026..032|V27-EXE-001..008|V27-SAF-001..008|V27-REC-001..006|V27-OBS-001..005|V27-QA-001..007
...
Status `ACCEPTED`. A decisão foi aprovada pela revisão crítica independente `LEA-31` no Reteste 02 e publicada com confirmação final da LEA-30. A aceitação não executa testes, não aprova runtime e não libera o gate LIVE.