...
ADRS=0002,0003,0004,0009,0010,0012,ADR-0001,ADR-0009,ADR-0012,ADR-0018
...
GATE_DE_SAÍDA=FND-001_EXIT_PASS
...
TESTE_LOCAL_DO_LEO=script fail-closed fixa repositório, commit, versão, testes e relatório
COMANDO_ÚNICO_LOCAL=bash scripts/local_validate_fnd_002.sh --expected-commit <CANDIDATE_HEAD>
...
GATE_DE_SAÍDA=FND-002_EXIT_PASS
...
ADRS=0002,0003,0008,0012,ADR-0001,ADR-0002,ADR-0004
MODO_MÁXIMO=NULL_ONLY
...
GATE_DE_SAÍDA=FND-003_EXIT_PASS
...
ADRS=0002,0003,0013,ADR-0001,ADR-0002
MODO_MÁXIMO=NULL_ONLY
...
GATE_DE_SAÍDA=DAT-001_EXIT_PASS
...
ADRS=0002,0018,ADR-0001,ADR-0009
MODO_MÁXIMO=NULL_ONLY
SITUAÇÃO_ATUAL=BLOCKED_BY_PREDECESSOR
CRITÉRIOS_DE_ENTRADA=PREDECESSORS_PASS + HUMAN_MISSION_AUTHORIZATION + EXPECTED_MAIN_SHA_MATCH
ENTREGAS=implementação pequena; contratos; documentação; evidências; script local do incremento
...
GATE_DE_SAÍDA=LST-001_EXIT_PASS
...
GATE_DE_SAÍDA=PRF-001_EXIT_PASS
...
GATE_DE_SAÍDA=OBS-001_EXIT_PASS
...
GATE_DE_SAÍDA=CAP-001_EXIT_PASS
...
GATE_DE_SAÍDA=VAL-001_EXIT_PASS
...
GATE_DE_SAÍDA=MAP-001_EXIT_PASS
...
ADRS=0009,0017,ADR-0006,ADR-0008
MODO_MÁXIMO=NULL_ONLY
SITUAÇÃO_ATUAL=BLOCKED_BY_PREDECESSOR
CRITÉRIOS_DE_ENTRADA=PREDECESSORS_PASS + HUMAN_MISSION_AUTHORIZATION + EXPECTED_MAIN_SHA_MATCH
ENTREGAS=implementação pequena; contratos; documentação; evidências; script local do incremento
...
GATE_DE_SAÍDA=ANA-001_EXIT_PASS
...
GATE_DE_SAÍDA=SIG-001_EXIT_PASS
...
ADRS=0008,0009,0010,0011,0016,ADR-0004,ADR-0008
MODO_MÁXIMO=NULL_ONLY
SITUAÇÃO_ATUAL=BLOCKED_BY_PREDECESSOR
CRITÉRIOS_DE_ENTRADA=PREDECESSORS_PASS + HUMAN_MISSION_AUTHORIZATION + EXPECTED_MAIN_SHA_MATCH
ENTREGAS=implementação pequena; contratos; documentação; evidências; script local do incremento
...
GATE_DE_SAÍDA=CMD-001_EXIT_PASS
...
GATE_DE_SAÍDA=ADP-001_EXIT_PASS
...
ADRS=0015,0016,ADR-0011,ADR-0015,ADR-0016
MODO_MÁXIMO=SIMULATED
SITUAÇÃO_ATUAL=BLOCKED_BY_PREDECESSOR
CRITÉRIOS_DE_ENTRADA=PREDECESSORS_PASS + HUMAN_MISSION_AUTHORIZATION + EXPECTED_MAIN_SHA_MATCH
ENTREGAS=implementação pequena; contratos; documentação; evidências; script local do incremento
...
GATE_DE_SAÍDA=EXE-001_EXIT_PASS
...
ADRS=0010,0012,0014,0018,ADR-0009,ADR-0010,ADR-0012
MODO_MÁXIMO=SIMULATED
SITUAÇÃO_ATUAL=BLOCKED_BY_PREDECESSOR
CRITÉRIOS_DE_ENTRADA=PREDECESSORS_PASS + HUMAN_MISSION_AUTHORIZATION + EXPECTED_MAIN_SHA_MATCH
ENTREGAS=implementação pequena; contratos; documentação; evidências; script local do incremento
...
GATE_DE_SAÍDA=SEC-001_EXIT_PASS
...
ADRS=0009,0010,0012,ADR-0005,ADR-0009
...
GATE_DE_SAÍDA=CUI-001_EXIT_PASS
...
GATE_DE_SAÍDA=LIV-GATE-001_EXIT_PASS
